        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_Package_PackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LineItems_Package_PackageId",
                        column: x => x.PackageId,
                        principalTable: "Package",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LineItems_Places_PlaceId",
                        column: x => x.PlaceId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LineItems_PackageId",
                table: "LineItems",
                column: "PackageId");

            migrationBuilder.CreateIndex(
                name: "IX_LineItems_PlaceId",
                table: "LineItems",
                column: "PlaceId");
